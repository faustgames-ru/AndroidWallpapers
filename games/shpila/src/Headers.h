...
#define WUKA_CHARGE_SPEED_FACTOR 5.0f
...
#define CORE_TIME_WARP_ABILITY_COLDDOWN 30000.0f
#define CORE_TIME_WARP_LIFE_TIME 30000.0f
#define CORE_TIME_WARP_RADIUS 3.5f
#define CORE_TIME_WARP_MANA_COST 100.0f
#define CORE_TIME_WARP_ABILITY_RANGE 9.0f
#define CORE_TIME_WARP_SPEED_FACTOR 0.5f
