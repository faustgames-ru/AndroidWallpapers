    ...
    Mesh::IndexFormat indexFormat, unsigned int indexCount, bool dynamic)
{
    ...
    GLuint vbo = MeshPart::crateDeviceObject(indexFormat, indexCount, dynamic);
...
IndexBufferHandle MeshPart::crateDeviceObject(Mesh::IndexFormat indexFormat, unsigned int indexCount, bool dynamic)
{
	GLuint vbo;
...
void MeshPart::RestoreDeviceObject()
{
	_indexBuffer = MeshPart::crateDeviceObject(_indexFormat, _indexCount, _dynamic);
}
