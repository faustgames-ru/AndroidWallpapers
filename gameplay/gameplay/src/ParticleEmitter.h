...
public:
	...
	typedef ParticleEmitter* (*ParticleEmitterConstructorProc) (int maxParticlesCount);
     ...
     * @script{create}
     */
	static ParticleEmitter* create(const char* url, ParticleEmitterConstructorProc constructor = NULL);
     ...
     * @script{create}
     */
	static ParticleEmitter* create(Properties* properties, ParticleEmitterConstructorProc constructor = NULL);
     ...
     * @script{create}
     */
	static ParticleEmitter* create(const char* texturePath, BlendMode blendMode, unsigned int particleCountMax, ParticleEmitterConstructorProc constructor = NULL);

	/**
	* Generate position of new particle
	*/
...
protected:
     ...
     * @script{create}
     */
	static ParticleEmitter* create(Texture* texture, BlendMode blendMode, unsigned int particleCountMax, ParticleEmitterConstructorProc constructor = NULL);
	...
	//copy data from this to emitter
	virtual void copyData(ParticleEmitter* emitter);
