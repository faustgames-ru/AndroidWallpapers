...
public:
	...
	static Texture* create(Format format, unsigned int width, unsigned int height, unsigned char* textureData, bool generateMipmaps = false, Texture::Type type = TEXTURE_2D);
