...
Mesh* Bundle::loadMesh(const char* id, const char* nodeId)
{
    ...
    // Read mesh data.
    Mesh::MeshData* meshData = readMeshData();
    if (meshData == NULL)
    {
...
Mesh::MeshData* Bundle::readMeshData()
{
    ...
    Mesh::MeshData* meshData = new Mesh::MeshData(VertexFormat(vertexElements, vertexElementCount));
    SAFE_DELETE_ARRAY(vertexElements);
    ...
    for (unsigned int i = 0; i < meshPartCount; ++i)
    {
        ...
        Mesh::MeshPartData* partData = new Mesh::MeshPartData();
...
Mesh::MeshData* Bundle::readMeshData(const char* url)
{
    GP_ASSERT(url);
    ...
    Mesh::MeshData* meshData = bundle->readMeshData();
